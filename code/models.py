...
class CFM():
    def __init__(self,features_sizes,loss_type='rmse',k=10,FM_ignore_interaction=None,dropout_keeprate=1.0,lambda_l2=0.0,metric_type=None):#todo lambda_L2 only added for AFM
        self.model=Alita_DeepFM(features_sizes=features_sizes,loss_type=loss_type,k=k,use_LR=True,use_FM=True,use_CFM=True,use_MLP=False,FM_ignore_interaction=FM_ignore_interaction,dropout_keeprate=dropout_keeprate,lambda_l2=lambda_l2,metric_type=metric_type)
