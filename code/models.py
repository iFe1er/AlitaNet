...
class MLP():
    def __init__(self,features_sizes,loss_type='rmse',deep_layers=(256,256),activation=tf.nn.relu,k=10,dropout_keeprate=1.0,metric_type=None):
        self.model=Alita_DeepFM(features_sizes=features_sizes,loss_type=loss_type,k=k,deep_layers=deep_layers,activation=activation,use_LR=False,use_FM=False,use_MLP=True,dropout_keeprate=dropout_keeprate,metric_type=metric_type)
...
class DeepFM():
    def __init__(self,features_sizes,loss_type='rmse',deep_layers=(256,256),activation=tf.nn.relu,k=10,FM_ignore_interaction=None,dropout_keeprate=1.0,metric_type=None):
        self.model=Alita_DeepFM(features_sizes=features_sizes,loss_type=loss_type,k=k,deep_layers=deep_layers,activation=activation,use_LR=True,use_FM=True,use_MLP=True,FM_ignore_interaction=FM_ignore_interaction,dropout_keeprate=dropout_keeprate,metric_type=metric_type)
...
class DeepAFM():
    def __init__(self,features_sizes,loss_type='rmse',deep_layers=(256,256),activation=tf.nn.relu,k=10,FM_ignore_interaction=None,attention_FM=10,dropout_keeprate=1.0,metric_type=None):
        self.model=Alita_DeepFM(features_sizes=features_sizes,loss_type=loss_type,k=k,deep_layers=deep_layers,activation=activation,use_LR=True,use_FM=True,use_MLP=True,FM_ignore_interaction=FM_ignore_interaction,attention_FM=attention_FM,dropout_keeprate=dropout_keeprate,metric_type=metric_type)
...
class AutoInt():
    def __init__(self,features_sizes,loss_type='rmse',k=10,FM_ignore_interaction=None,dropout_keeprate=1.0,metric_type=None):
        self.model=Alita_DeepFM(features_sizes=features_sizes,loss_type=loss_type,k=k,use_LR=False,use_FM=False,use_MLP=False,use_AutoInt=True,FM_ignore_interaction=FM_ignore_interaction,dropout_keeprate=dropout_keeprate,metric_type=metric_type)
