...
class Alita_DeepFM(BaseEstimator):
    ...
    def __init__(self,features_sizes,dense_features_size=0,loss_type='rmse',k=10,deep_layers=(256,256),activation=tf.nn.relu,use_LR=True,use_MLR=False,use_MFM=False,use_FM=True,use_MLP=True,use_CrossNet_layers=0,FM_ignore_interaction=None,attention_FM=0,use_CFM=False,MLR_m=4,MFM_m=4,use_NFM=False,use_BiFM=False,use_SE=False,use_FiBiNet=False,use_AutoInt=False,autoint_params=None,dropout_keeprate=1.0,lambda_l2=0.0,hash_size=None,metric_type=None):
        ...
        self.use_LR=use_LR
        self.use_MLR = use_MLR#mix-LR
        self.use_MFM = use_MFM#mix-FM
        self.MLR_m = MLR_m
        self.MFM_m = MFM_m
        self.use_FM=use_FM
